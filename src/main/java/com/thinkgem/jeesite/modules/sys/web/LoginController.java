...
public class LoginController extends BaseController{
	...
	@RequestMapping(value = "${adminPath}/regist")
	public String regist(Model model){
		model.addAttribute("allRoles", systemService.findAllRoles());
		return "modules/sys/regist";
	}
	
	@RequestMapping(value = "${adminPath}/doSave")
	public String doSave(User user,MultipartHttpServletRequest request,Model model,RedirectAttributes redirectAttributes) throws Exception {
		...
		User glUser=systemService.getUserByLoginName("thinkgem");
		user.setCreateBy(glUser);
		user.setUpdateBy(glUser);
		// 保存用户信息
	...
	@RequestMapping(value = "${adminPath}/checkName")
