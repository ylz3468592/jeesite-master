...
public class SystemService extends BaseService implements InitializingBean {
	 ...
	 * @return
	 */
	public List<User> getAllFirstGrid(String roleName,String flag){
		return userDao.getAllFirstGrid(roleName,flag);
	}
	 ...
	 * @return
	 */
	public List<User> getAllPrc(String roleName,String flag){
		return userDao.getAllPrc(roleName,flag);
	}
	 ...
	 * @return
	 */
	public List<User> getAllFirstGridNot(String roleName,String flag){
		return userDao.getAllFirstGridNot(roleName, flag);
	}
